...
(function() {
  ...
  function initProgressBar() {
    ...
    window.addEventListener('scroll', function() {
      ...
      if (p > 85 && !window._nearMissShown) {
        ...
        showToast('거의 다 읽으셨어요! 끝까지 보면 특별한 메시지가 있어요 🎁', 4500);
      }
  ...
  function initCuriosityGap() {
    var teasers = {
      ...
      contact: [
        ...
        { page: 'story', text: '이곳의 이야기를 알면 더 특별한 밤이 됩니다' },
      ],
    };
  ...
  function triggerJackpot() {
    var jackpots = [
      { title: '🎰 잭팟!', sub: '운이 좋으시네요! 이 페이지에서 특별한 에너지가 감지되었습니다' },
      { title: '⭐ 럭키 모먼트!', sub: '챔피언나이트가 오늘 당신을 위해 준비한 건...' },
      { title: '🎲 보너스 타임!', sub: '당신은 오늘의 행운의 방문자입니다!' },
      { title: '💫 스페셜 이벤트!', sub: '이 순간을 기억하세요. 특별한 밤이 기다립니다' },
